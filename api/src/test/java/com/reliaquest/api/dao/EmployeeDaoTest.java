...
class EmployeeDaoTest {
    ...
    void setUp() {
        ...
        // Initialize data
        employeeRequest = new EmployeeRequest("Akash Ghuge", 100000, "Software Engineer", 30);
        employee = new Employee(UUID.randomUUID(), "Akash Ghuge", 100000, 30, "Software Engineer", "akash.ghuge@gmail.com");
    ...
    void testAddEmployee_ThrowsExternalApiException_WhenResponseIsNull() {
        ...
        assertThrows(ApiException.class, () -> employeeDao.addEmployee(employeeRequest));
    }
    ...
    void testGetListOfAllEmployees_ThrowsExternalApiException_WhenResponseIsNull() {
        ...
        assertThrows(ApiException.class, employeeDao::getListOfAllEmployees);
    }
    ...
    void testDeleteEmployeeByName_ThrowsExternalApiException_WhenDeletionFails() {
        ...
        assertThrows(ApiException.class, () -> employeeDao.deleteEmployeeByName(employee.getId().toString()));
    }
    ...
    void testGetEmployeeById_ThrowsExternalApiException_OnServiceUnavailable() {
        ...
        assertThrows(ApiException.class, () -> employeeDao.getEmployeeById("12345"));
    }
