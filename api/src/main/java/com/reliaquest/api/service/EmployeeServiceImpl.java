...
public class EmployeeServiceImpl implements IEmployeeService {
    ...
    public List<Employee> getEmployeesByNameSearch(String name) {
        ...
        if (employeeList.isEmpty()) {
            ...
            throw new EmployeeException(String.format("No employees found with name: %s", name), AppConstants.NAME);
        }
    ...
    public Integer getHighestSalaryOfEmployees() {
        ...
        return employeeDao.getListOfAllEmployees().stream()
                ...
                .orElseThrow(() -> {
                    ...
                    return new EmployeeException("No employees found or no salaries available", AppConstants.NA);
                });
    }
