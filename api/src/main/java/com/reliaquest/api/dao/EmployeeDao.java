...
public class EmployeeDao {
    ...
    public Employee addEmployee(EmployeeRequest request) {
        ...
        try {
            ...
            if (apiResponse == null || apiResponse.getData() == null) {
                throw new ApiException("Failed to add employee. Response is null.");
            }
            ...
            handleException(e, AppConstants.NA);
    ...
    public List<Employee> getListOfAllEmployees() {
        ...
        try {
            ...
            if (apiResponse == null || apiResponse.getData() == null) {
                throw new ApiException("Failed to retrieve employees. Response is null.");
            }
    ...
    public Employee getEmployeeById(String id) {
        String uri = AppConstants.FORWARD_SLASH + id;
        ...
        try {
            ApiResponse<Employee> apiResponse = webClient.get()
                    ...
                    .block();
            if (apiResponse == null || apiResponse.getData() == null) {
                throw new EmployeeException("Employee not Found", AppConstants.ID);
            }
            logger.info("EmployeeDao - Successfully retrieved employee with id: {}", id);
            return apiResponse.getData();

        } catch (Exception e) {
            handleException(e, AppConstants.ID);
            return null;
        }
    }
    public String deleteEmployeeByName(String id) {
        ...
        try {
            ...
            if (apiResponse == null || apiResponse.getData() == null || !apiResponse.getData()) {
                throw new ApiException("Failed to delete employee. Response is null or deletion unsuccessful.");
            }
            ...
            handleException(e, AppConstants.NAME);
            return null;
        }
    }
    ...
    private void handleException(Exception e, String requestIdentificationParam) {
        if (e instanceof WebClientResponseException ex) {
            if (ex.getStatusCode() == HttpStatus.TOO_MANY_REQUESTS) {
                ...
                throw new ApiException("Error occurred while processing employee details. Check your request or try again later.");
            }
        } else {
            logger.error("EmployeeDao - Unexpected error occurred: {}", e.getMessage());
            throw new ApiException("An unexpected error occurred while processing the request.");
        }
    }
}
